...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Returns the group of libraries at maplibre
     */
    ...
    public static class MaplibreLibraryAccessors extends SubDependencyFactory {
        private final MaplibreNavigationLibraryAccessors laccForMaplibreNavigationLibraryAccessors = new MaplibreNavigationLibraryAccessors(owner);

        public MaplibreLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for sdk (org.maplibre.gl:android-sdk)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getSdk() {
                return create("maplibre.sdk");
        }

        /**
         * Returns the group of libraries at maplibre.navigation
         */
        public MaplibreNavigationLibraryAccessors getNavigation() {
            return laccForMaplibreNavigationLibraryAccessors;
        }

    }

    public static class MaplibreNavigationLibraryAccessors extends SubDependencyFactory {

        public MaplibreNavigationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for android (com.github.maplibre:maplibre-navigation-android)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAndroid() {
                return create("maplibre.navigation.android");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: maplibre (10.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: maplibreNavigationAndroid (3.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getMaplibreNavigationAndroid() { return getVersion("maplibreNavigationAndroid"); }
            ...
            /**
             * Returns the version associated to this alias: originsSdkKotlin (1.0.7)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getOriginsSdkKotlin() { return getVersion("originsSdkKotlin"); }
    ...
    public static class Okhttp3LoggingVersionAccessors extends VersionFactory  {
        ...
        public Okhttp3LoggingVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: okhttp3.logging.interceptor (4.9.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
