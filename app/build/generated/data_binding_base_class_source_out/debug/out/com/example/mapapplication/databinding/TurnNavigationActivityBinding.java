...
public final class TurnNavigationActivityBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final TextView maneuversbutton;

  @NonNull
  public final MapView mapView;

  @NonNull
  public final TextView optimalRoute;
  ...
  @NonNull
  public final TextView shortestRoute;
  ...
  private TurnNavigationActivityBinding(@NonNull RelativeLayout rootView,
      @NonNull TextView addWayPoint, @NonNull LinearLayout bicycleLayout,
      @NonNull TextView bikeTime, @NonNull LinearLayout bottomView, @NonNull LinearLayout busLayout,
      @NonNull TextView busTime, @NonNull LinearLayout carLayout, @NonNull TextView carTime,
      ...
      @NonNull TextView maneuversbutton, @NonNull MapView mapView, @NonNull TextView optimalRoute,
      ...
      @NonNull TextView shortestRoute, @NonNull ImageView shuffle,
      @NonNull TextView startRouteButton, @NonNull FloatingActionButton startRouteButton1,
      @NonNull LinearLayout startRouteLayout, @NonNull TextView time, @NonNull LinearLayout timeLyt,
      @NonNull Toolbar toolbar, @NonNull LinearLayout truckLayout, @NonNull TextView truckTime,
    ...
    this.maneuversbutton = maneuversbutton;
  ...
  @NonNull
  public static TurnNavigationActivityBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static TurnNavigationActivityBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.turn_navigation_activity, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static TurnNavigationActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.maneuversbutton;
      TextView maneuversbutton = ViewBindings.findChildViewById(rootView, id);
      if (maneuversbutton == null) {
        break missingId;
      }
      ...
      id = R.id.optimalRoute;
      TextView optimalRoute = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.shortestRoute;
      TextView shortestRoute = ViewBindings.findChildViewById(rootView, id);
      ...
      return new TurnNavigationActivityBinding((RelativeLayout) rootView, addWayPoint,
          bicycleLayout, bikeTime, bottomView, busLayout, busTime, carLayout, carTime,
          clearDestination, clearOrigin, clearPoints, container, containerNav, containerNavigation,
          destinationAutocomplete, destinationPoint, distance, fabRecenter, fabStyles, frame,
          legendContainer, mainContainer, maneuversbutton, mapView, optimalRoute,
          originAutocomplete, originPoint, recyclerViewSearch, recyclerWayPoints, shortestRoute,
          shuffle, startRouteButton, startRouteButton1, startRouteLayout, time, timeLyt, toolbar,
          truckLayout, truckTime, walkLayout, walkTime);
    }
