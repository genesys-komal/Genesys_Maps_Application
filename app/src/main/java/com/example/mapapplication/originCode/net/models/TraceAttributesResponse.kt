 ...
 * @param units 
 * @param alternatePaths Alternate paths, if any, that were not classified as the best match.
 */


data class TraceAttributesResponse (
    ...
    val alternatePaths: kotlin.collections.List<TraceAttributesBaseResponse>? = null
