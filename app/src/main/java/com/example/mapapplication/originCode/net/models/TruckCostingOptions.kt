 ...
 * @param height The height of the truck (in meters).
 * @param width The width of the truck (in meters).
 ...
 * @param length The length of the truck (in meters).
 * @param weight The weight of the truck (in tonnes).
 * @param axleLoad The axle load of the truck (in tonnes).
 * @param hazmat Whether or not the truck is carrying hazardous materials.
 */


data class TruckCostingOptions (
    ...
    val height: kotlin.Double? = 4.11,

    /* The width of the truck (in meters). */
    @SerializedName("width")
    val width: kotlin.Double? = 2.6,
