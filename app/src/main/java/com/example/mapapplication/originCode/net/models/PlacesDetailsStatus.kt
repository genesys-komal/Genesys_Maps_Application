 ...
 *
 * Values: OK,ZERO_RESULTS,INVALID_REQUEST,NOT_FOUND,OVER_QUERY_LIMIT,REQUEST_DENIED,UNKNOWN_ERROR
 */

enum class PlacesDetailsStatus(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is PlacesDetailsStatus) "$data" else null

        /**
         * Returns a valid [PlacesDetailsStatus] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): PlacesDetailsStatus? = data?.let {
